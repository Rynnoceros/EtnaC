...
**
**    my_strcmp allows you to compare two strings if these strings are equal
**    then the function returns 0.
**
**    my_strdup allows you to dynamically allocate a string and copy the
**    content of the string passed as parameter and return it.
**
**    my_putstr_color allows you to display a string on the standard output
**    in the desired color.
**    The colors available for this function are:
**      "red", "green", "yellow", "blue", "purple" and "cyan"
**    This function also allows you to "clear" everything that is currently
