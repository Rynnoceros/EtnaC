...
int main(void)
{
    ...
    printf("Adding 10\n");
    my_put_elem_in_sort_list(&sorted_list, &i, compare_int);
    print_list(sorted_list);
    ...
    printf("Removing 7\n");
    my_rm_all_eq_from_list(&sorted_list, &d, compare_int);
    print_list(sorted_list);

    printf("Removing 10\n");
    my_rm_all_eq_from_list(&sorted_list, &c, compare_int);
    print_list(sorted_list);

    printf("Removing 5\n");
    my_rm_all_eq_from_list(&sorted_list, &b, compare_int);
    print_list(sorted_list);

    printf("Removing 15\n");
    my_rm_all_eq_from_list(&sorted_list, &f, compare_int);
    print_list(sorted_list);
    ...
    printf("Adding 1\n");
    my_put_elem_in_sort_list(&sorted_list, &h, compare_int);
    print_list(sorted_list);

    printf("Removing 1\n");
    my_rm_all_eq_from_list(&sorted_list, &a, compare_int);
    print_list(sorted_list);
    return 0;
}
